        ...
        <article className='center b--black ba b--solid w-20-ns shadow-3'>
            <main className="pa4 black-80">
                <div className="measure ">
                    ...
                    <legend className="f4 fw6 ph0 mh0 f2">Register</legend>
                    <div className="mt3">
                        <label className="db fw6 lh-copy f6" htmlFor="name">Name</label>
                        <input onChange={this.onNameChange} className="pa2 input-reset ba bg-transparent hover-bg-black hover-white f5 h2 w-100" type="text" name="name"  id="name"/>
                    </div>
                    <div className="mt3">
